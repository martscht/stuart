...
#' 
### Details ----
#' The pheromone function provided via \code{fitness.func} is used to assess the quality of the solutions. These functions can contain any combination of the fit indices provided by the estimation software. When using Mplus these fit indices are 'rmsea', 'srmr', 'cfi', 'tli', 'chisq' (with 'df' and 'pvalue'), 'aic', 'bic', and 'abic'. With lavaan any fit index provided by \code{\link[lavaan]{inspect}} can be used. Additionally 'crel' provides an aggregate of composite reliabilites, 'rel' provides a vector or a list of reliability coefficients for the latent variables, 'con' provides an aggregate consistency estimate for MTMM analyses, and 'lvcor' provides a list of the latent variable correlation matrices. For more detailed fitness functions 'lambda', 'theta', 'psi', and 'alpha' provide the model-implied matrices. Per default a pheromone function using 'crel', 'rmsea', and 'srmr' is used. Please be aware that the \code{fitness.func} must be a function with the required fit indices as (correctly named) arguments.
#' 
...
function(
  ...
  repeated.measures=NULL, #long.invariance='strict', 
  item.long.invariance='strict', #long structure
  
  mtmm=NULL, #mtmm.invariance='congeneric', 
  item.mtmm.invariance='congeneric', #MTMM structure

  grouping=NULL, #group.invariance='strict', 
  item.group.invariance='strict', #grouping structure
